                ...
                "columns": [
                    ...
                    { "data": "fechareg" },
                    {
                        ...
                        "render": function (data, type, row) {
                            return `
                        <button class="btn btn-sm btn-warning edit" data-id="` + data.idDoc + `"><i class="align-middle me-2 fas fa-fw fa-edit"></i>Editar</button>
                        <button class="btn btn-sm btn-danger delete" data-id="` + data.idDoc + `"><i class="align-middle me-2 fas fa-fw fa-trash-alt"></i>Eliminar</button>
                    `;
                        }
                    }
                ],

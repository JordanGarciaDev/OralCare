                ...
                "columns": [
                    ...
                    { "data": "fechareg" },
                    {
                        ...
                        "render": function (data, type, row) {
                            return `
                        <button class="btn btn-sm btn-success edit" data-id="` + data.idDoc + `"><i class="align-middle fas fa-fw fa-edit"></i>Editar</button>
                        <button class="btn btn-sm btn-danger delete" data-id="` + data.idDoc + `"><i class="align-middle fas fa-fw fa-trash-alt"></i></button>
                    `;
                        }
                    }
                ],

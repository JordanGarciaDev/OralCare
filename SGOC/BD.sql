...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `empleados_ibfk_2` FOREIGN KEY (`cargo`) REFERENCES `perfiles` (`id`),
...
insert  into `empleados`(`id`,`nombre_completo`,`tipo_doc`,`num_doc`,`lug_exp`,`fec_nacimiento`,`nacionalidad`,`sexo`,`estado_civil`,`dir_residencia`,`barrio_residencia`,`ciudad_residencia`,`tel_movil`,`email_personal`,`email_empresarial`,`cargo`,`estado`) values (5,'Jaime Borja Altamar',8,'12345',88,'0000-00-00','COLOMBIANA','M',1,'CL 123','LAS DELICIAS',88,3045937472,'ing.jordangarcia@gmail.com',NULL,15,1);
...
insert  into `perfiles`(`id`,`nombre`) values (1,'Asesor Comercial Ventas');
insert  into `perfiles`(`id`,`nombre`) values (2,'Anfitrion');
insert  into `perfiles`(`id`,`nombre`) values (3,'Auxiliar contable ');
insert  into `perfiles`(`id`,`nombre`) values (4,'Coordinadora de Recursos Humanos ');
insert  into `perfiles`(`id`,`nombre`) values (5,'Asesor Comercial Seguimiento');
insert  into `perfiles`(`id`,`nombre`) values (6,'Mantenimiento');
insert  into `perfiles`(`id`,`nombre`) values (7,'Auxiliar de Aseo y Desinfección ');
insert  into `perfiles`(`id`,`nombre`) values (8,'Auxiliar de Odontología');
insert  into `perfiles`(`id`,`nombre`) values (9,'Odontólogo General');
insert  into `perfiles`(`id`,`nombre`) values (10,'Endodoncista');
insert  into `perfiles`(`id`,`nombre`) values (11,'Implantólogo Oral');
insert  into `perfiles`(`id`,`nombre`) values (12,'Rehabilitador Oral');
insert  into `perfiles`(`id`,`nombre`) values (13,'Ortodoncista ');
insert  into `perfiles`(`id`,`nombre`) values (14,'Tecnico Electricista');
insert  into `perfiles`(`id`,`nombre`) values (15,'Desarrollador Web');
insert  into `perfiles`(`id`,`nombre`) values (16,'Gerente Comercial');
insert  into `perfiles`(`id`,`nombre`) values (17,'Gerente General');
insert  into `perfiles`(`id`,`nombre`) values (18,'Coordinador Administrativo ');
insert  into `perfiles`(`id`,`nombre`) values (19,'Coordinador de marketing');
insert  into `perfiles`(`id`,`nombre`) values (20,'Recepciónista');
...
insert  into `tipo_de_documento`(`id`,`nombre`) values (1,'Pasaporte');
insert  into `tipo_de_documento`(`id`,`nombre`) values (2,'Documento de indetificacién para extranjeros');
insert  into `tipo_de_documento`(`id`,`nombre`) values (3,'PEP');
insert  into `tipo_de_documento`(`id`,`nombre`) values (4,'Registro Profesional');
insert  into `tipo_de_documento`(`id`,`nombre`) values (5,'Carnet Diplomático');
insert  into `tipo_de_documento`(`id`,`nombre`) values (6,'Salvocondcuto');
insert  into `tipo_de_documento`(`id`,`nombre`) values (7,'Certificado de nacido vivo');
insert  into `tipo_de_documento`(`id`,`nombre`) values (8,'Cédula de ciudadanía');
insert  into `tipo_de_documento`(`id`,`nombre`) values (9,'NIT de otro país');
insert  into `tipo_de_documento`(`id`,`nombre`) values (10,'Tarjeta de identidad');
insert  into `tipo_de_documento`(`id`,`nombre`) values (11,'Cédula de extranjeria');
insert  into `tipo_de_documento`(`id`,`nombre`) values (12,'Registro civil de nacimiento');
insert  into `tipo_de_documento`(`id`,`nombre`) values (13,'Número único de identificación');
insert  into `tipo_de_documento`(`id`,`nombre`) values (14,'Menor sin identificar');
insert  into `tipo_de_documento`(`id`,`nombre`) values (15,'Adulto sin identificar');
insert  into `tipo_de_documento`(`id`,`nombre`) values (16,'NIT');
...
insert  into `usuarios`(`id`,`nombres`,`apellidos`,`usuario`,`pass`,`perfil`,`foto`,`fecha`) values (1,'Jordan','Dev','jgarcia','$2y$10$6GjLTQ5kq/JtaXgtw5I6n.PhQ/Nuo0FX7Gf24Wvu8IPVJVK1Dj7Qa',15,'6719adedc3d7d.png','2024-10-22 11:28:18');
insert  into `usuarios`(`id`,`nombres`,`apellidos`,`usuario`,`pass`,`perfil`,`foto`,`fecha`) values (2,'Daniel','Marquez','dmarquez','$2y$10$6GjLTQ5kq/JtaXgtw5I6n.PhQ/Nuo0FX7Gf24Wvu8IPVJVK1Dj7Qa',1,'6719aa93f2dc6.jpeg','2024-10-23 14:29:34');

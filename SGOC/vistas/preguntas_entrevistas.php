                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalLabel"><i class="align-middle me-2 far fa-fw fa-folder"></i>Nueva Pregunta</h5>
            ...
            "columns": [
                ...
                { "data": "tipo" },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        <button class="btn btn-sm btn-danger delete" data-id="` + data.idPreg + `"><i class="align-middle fas fa-fw fa-trash-alt"></i></button>
                    `;
                    }
                }
            ],
